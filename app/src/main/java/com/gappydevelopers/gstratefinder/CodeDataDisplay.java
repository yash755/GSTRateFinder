...
public class CodeDataDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_code_data_display);
    ...
    private void readFile1(final Context context) throws IOException {
        ...
        actv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View arg1, int pos,
                                    long id) {
                Toast.makeText(CodeDataDisplay.this," selected", Toast.LENGTH_LONG).show();
                ...
                while (i < gstModelArrayList.size()) {
                    if ((gstModelArrayList.get(i).getProduct_code()).contains(parent.getItemAtPosition(pos).toString())) {
